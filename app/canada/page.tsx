...
export default function CanadaPage() { return <div className="ca-page">
  ...
  <section className="ca-dream-line" aria-label="Destinations canadiennes"><div className="ca-dream-track"><p>Montréal <span>•</span> Toronto <span>•</span> Ottawa <span>•</span> Québec <span>•</span> Calgary <span>•</span> Vancouver <span>•</span></p><p aria-hidden="true">Montréal <span>•</span> Toronto <span>•</span> Ottawa <span>•</span> Québec <span>•</span> Calgary <span>•</span> Vancouver <span>•</span></p></div></section>
