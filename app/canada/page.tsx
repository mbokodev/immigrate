...
export default function CanadaPage() { return <div className="ca-page">
  <section className="ca-hero"><Image className="ca-hero-image" src="/canada-page/hero-toronto.png" alt="Jeune femme contemplant Toronto sous la neige" fill priority sizes="100vw" /><div className="ca-hero-overlay" /><div className="ca-hero-copy"><Link className="ca-back" href="/">← Choisir une autre destination</Link><p className="ca-kicker"><span>Canada</span> · Études, carrière & projet de vie</p><h1>Et si votre<br />prochaine vie<br /><em>commençait ici&nbsp;?</em></h1><p>Un grand projet commence souvent par une image. Nous vous aidons à la transformer en direction, en étapes et en décisions solides.</p><div className="ca-hero-actions"><a className="ca-button" href="#demarrer">Faire le premier pas <span>↗</span></a><a href="#possibles">Explorer les possibles <span>↓</span></a></div></div><div className="ca-scroll"><span /> Faites défiler pour rêver plus loin</div></section>
